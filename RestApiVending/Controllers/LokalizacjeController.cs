...
namespace RestApiVending.Controllers
{
    ...
    [ApiController]
    public class LokalizacjeController : ControllerBase
    {
        private readonly CompanyContext _context;

        public LokalizacjeController(CompanyContext context)
        {
            _context = context;
        }
