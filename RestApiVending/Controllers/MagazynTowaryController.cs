...
namespace RestApiVending.Controllers
{
    ...
    [ApiController]
    public class MagazynTowaryController : ControllerBase
    {
        private readonly CompanyContext _context;

        public MagazynTowaryController(CompanyContext context)
        {
            _context = context;
        }

        // GET: api/MagazynTowary
        [HttpGet]
