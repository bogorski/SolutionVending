...
public partial class CompanyContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => new { e.NumerMaszyny, e.Idtrasy }).HasName("PK__MaszynaT__3643C2A764850984");
            ...
            entity.HasOne(d => d.NumerMaszynyNavigation).WithMany(p => p.MaszynaTrasas)
                .OnDelete(DeleteBehavior.ClientSetNull)
