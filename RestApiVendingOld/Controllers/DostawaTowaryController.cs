...
namespace RestApiVending.Controllers
{
    ...
    [ApiController]
    public class DostawaTowaryController : ControllerBase
    {
        private readonly CompanyContext _context;

        public DostawaTowaryController(CompanyContext context)
        {
            _context = context;
        }

        // GET: api/DostawaTowary
        [HttpGet]
