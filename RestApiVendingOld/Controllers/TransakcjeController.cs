...
namespace RestApiVending.Controllers
{
    ...
    [ApiController]
    public class TransakcjeController : ControllerBase
    {
        private readonly CompanyContext _context;

        public TransakcjeController(CompanyContext context)
        {
            _context = context;
        }
